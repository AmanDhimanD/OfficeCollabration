        ...
        <header>
            <form action="php/create-admin.php" method="POST">
                ...
                <b>
                    ...
                    * Band 1 ( Software Engineer/QA/IT Consultant/Finance Consultant) <br>
                    * Band 2 (Lead Engineer and QA) <br>
                    * Band 3 (Engineering Manager)<br>
                    * Band 4 (Engineering Director)<br>
                    * Band 5 (Vice President)<br>
                    * Band 6(CTO)<br>
                    * Band 7 (CEO)<br>
                </b>
                <!-- </center> -->
